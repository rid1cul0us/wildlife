...
class CCTSubset(Dataset):
    # dataset csv file path
    image_base_path = "images/"
    train_path = "annotation/train.csv"
    cis_val_path = "annotation/cis_val.csv"
    trans_val_path = "annotation/trans_val.csv"
    cis_test_path = "annotation/cis_test.csv"
    trans_test_path = "annotation/trans_test.csv"
